...
const InviteModal: React.FC = () => {
        ...
        }),
        {
          ...
          error: {
            render({ data }) {
              ...
              return typeof data === 'string' ? data : 'Failed to send invitation'
            },
          },
        }
      )
  ...
  const closeModal = () => {
    ...
    setPlayer('') // Clear the input when closing
  }
  return (
    <div
