...
const CreateGame: React.FC = () => {
  ...
  const handleGameCreation = async (e: FormEvent) => {
    ...
    try {
      ...
      const endTime = new Date(game.endDate).getTime()
      ...
      game.startDate = startTime
      game.endDate = endTime
        ...
        new Promise(async (resolve, reject) => {
          createGame(game)
            ...
            .catch((error: any) => {
              ...
              reject(error.message || 'Failed to create game')
            })
        }),
        {
          ...
          error: {
            render({ data }) {
              ...
              return typeof data === 'string' ? data : 'Failed to create game'
            },
          },
        }
      )
